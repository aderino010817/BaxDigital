  ...
  return (
    <>
      ...
      <Box p={"3em"}>
        <Box mt={"15px"} mb={"3em"}>
          <Center>
            <Flex flexDirection={"column"}>
              ...
              >
                <Text>
                  Bax Digital adalah mitra terpercaya Anda dalam menghadirkan keindahan dan efisiensi bagi bisnis Anda melalui dunia digital. Sebagai tim Web Developer Professional, kami siap membantu Anda menghadirkan website yang tidak
                  hanya menarik, tetapi juga efisien dan ramah pengguna.
                </Text>
              </Box>
            </Flex>
          </Center>
        ...
        <Box>
          <Flex mt="10px" mb="15px" width="100%" justifyContent="center">
            <Center
              gap={{
                base: "1em",
                lg: "2em",
        ...
        <Center>
          <Flex width={"100%"} textAlign={"center"} justifyContent={"space-around"} gap={"4"} flexWrap={"wrap"} display={{ base: "grid", lg: "flex" }}>
            <Box
              ...
              border={"1px solid gray"}
              borderRadius={"13px"}
              boxShadow={"1px 2px 5px 1px gray"}
              pb={3}
              px={10}
              _hover={{
                border: "1px solid gray",
            ...
            >
              ...
              <Center textAlign={"center"}>
                ...
                <Text fontWeight={"semibold"} fontStyle={"oblique"} fontSize={"16"}>
                  Tahun
                </Text>
              </Center>
              <Divider />
